				...
				1: 
					match response:
						...
						"B":
							...
							dialog_state = 3
							# Show dialog popup
							dialog_popup.message = "Well, I'll be waiting like a tumbleweed 'til you come back."
							dialog_popup.response = "[A] Bye"
							dialog_popup.open() #re-open to show the next dialog
				2:
					# Update dialog tree state
					dialog_state = 0
